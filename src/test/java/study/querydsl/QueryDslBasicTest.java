...
import study.querydsl.domain.member.dto.MemberClassDto;
import study.querydsl.domain.member.dto.MemberRecordDto;
import study.querydsl.domain.member.dto.QMemberRecordDto;
...
//                .where(usernameEq(usernameCond), ageEq(ageCond))
    ...
    private BooleanExpression allEq(String usernameCond, Integer ageCond) {
        return usernameCond == null ? ageEq(ageCond) : usernameEq(usernameCond).and(ageEq(ageCond));
    }
    ...
    public void bulkUpdate() {
        ...
        result.forEach(member -> System.out.println("member.getUsername = " + member.getUsername()));
